...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        // check the state of event emitted
        truffleAssertions.eventEmitted(event, 'Harvested');
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'Processed');
        ...
        // verify the result
        assert.equal(resultBufferTwo[5], 1, 'Error: Invalid item state (Processed)');
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Invalid Origin farmer ID (Processed');
    });
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'Packed');
        ...
        // verify the result
        assert.equal(resultBufferTwo[5], 2, 'Error: Invalid item state (Processed)');
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Invalid Origin farmer ID (Processed');
    });
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'ForSale');
        ...
        // verify the result
        assert.equal(resultBufferTwo[5], 3, 'Error: Invalid item state (Processed)');
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Invalid Origin farmer ID (Processed');
    });
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'Sold');

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)   

        // verify the result
        assert.equal(resultBufferTwo[5], 4, 'Error: Invalid item state (Processed)');
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Invalid Origin farmer ID (Processed');
    });
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'Shipped');

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)   

        // verify the result
        assert.equal(resultBufferTwo[5], 5, 'Error: Invalid item state (Processed)');
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Invalid Origin farmer ID (Processed');
    })
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'Received');

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)   

        // verify the result
        assert.equal(resultBufferTwo[5], 6, 'Error: Invalid item state (Processed)');
        // assert.equal(resultBufferTwo[7], retailerID, 'Error: Invalid Origin farmer ID (Processed');
    });
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // check the state of the event emitted
        truffleAssertions.eventEmitted(event, 'Purchased');

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc) 
        
        // verify the result
        assert.equal(resultBufferTwo[5], 7, 'Error: Invalid item state (Processed)');
