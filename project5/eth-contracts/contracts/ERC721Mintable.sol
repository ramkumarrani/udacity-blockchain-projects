...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "only owner can call the function");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "new owner is not the right address");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    event Paused(address eventAddress);
    event Unpaused(address eventAddress);
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "cannot self approve");
...
// complete up to here.. Ramkumar Rani
