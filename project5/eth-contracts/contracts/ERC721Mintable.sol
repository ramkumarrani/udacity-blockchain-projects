...
contract Ownable {
    ...
    constructor() internal {
        _owner = msg.sender;
        emit TransferedOwnership(address(0), msg.sender);
    }

    //  3) create an 'onlyOwner' modifier that throws if called by any account other than the owner.
    modifier onlyOwner() {
        require(_owner == msg.sender, "Only the owner can call this");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Bad newOwner address");
...
//  2) create a public setter using the inherited onlyOwner modifier 
    function setPaused(bool flag) public onlyOwner {
        _paused  = flag;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Given address it can not be the owner of the tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(msg.sender, to), "Not authorised to approve the given token ID transfer");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From address is not tokenId owner");
...
contract RRERC721Token is ERC721Metadata {
//  1) Pass in appropriate values for the inherited ERC721Metadata contract
//      - make the base token uri: https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/
    string constant private tokenURI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";

    constructor(string memory name, string memory symbol) public ERC721Metadata(name, symbol, tokenURI) {}
