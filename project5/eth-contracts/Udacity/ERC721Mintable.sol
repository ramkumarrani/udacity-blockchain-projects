...
contract Ownable {
    ...
    // function to return true if msg.sender is the contract owner
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused == true, "contract is currently not paused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "self approval not allowed");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require (msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "caller is not authorized for this token for approval");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Only token owner allowed to perform this");
