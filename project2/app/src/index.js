...
const App = {
  web3: null,
  account: null,
  meta: null, // this object represents the smart contract
  ...
  start: async function() {
    ...
    try {
      ...
      // get accounts
      const accounts = await web3.eth.getAccounts(); //get all test accounts
  ...
  // function to upload the status message in the page
  ...
  createStar: async function() {
   ...
   // calling lookUptokenIdToStarInfo method from starNotary smart contract
